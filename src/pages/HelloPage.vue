...
<template>
  <div class="hello-wrapper flex justify-around items-center w-full h-screen">
    <div
      class="background-none hello-left relative flex justify-center flex-col p-2 sm:p-0 items-center sm:items-start"
    >
      <p class="text-white">Hi all. I am</p>
      <h1 class="text-6xl font-bold text-white text-center">Javohir Hasanov</h1>
      <p class="text-secondary-300 text-2xl font-bold mb-8">
        > Front-end developer
      </p>
      ...
      <p>
        <span class="text-secondary-300 mr-1">const</span>
        <span class="text-a mr-1">githubLink</span>
        ...
        <span class="text-accent-100" title="GitHub">
          <a href="https://github.com/LazyBrogrammer"
            >https://github.com/LazyBrogrammer</a
          ></span
        >
      </p>
      <div
